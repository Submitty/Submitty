...
avg_hours_ot_week_ds = [[0]*24 for _ in range(7)]
...
for filename in os.listdir(path):
    ...
    for line in contents.readlines():
        if (line[40:45] != "BATCH"):
            ...
            if (info[1] == "ds"):  # Data Structures
                submission_temp_cs1200 += 1
                avg_hours_ot_week_ds[day_of_week][hour] += 1
...
for x in range(7):
    ...
    avg_hours_ot_week_ds[x][:] = [d // (2*number_of_weekdays[x]) for d in avg_hours_ot_week_ds[x]]
