 ...
 * @method string getQueueContactInfoRequirement()
...
class Config extends AbstractModel {
    ...
    /** @prop @var string */
    //protected $queue_contact_info_requirement;
    /** @prop @var string */
    ...
    public function loadCourseJson($semester, $course, $course_json_path) {
        ...
        $array = [
            ...
            'regrade_message', 'auto_rainbow_grades', 'queue_enabled', 'queue_contact_info', 'queue_message', /*'queue_contact_info_requirement',*/ 'polls_enabled', 'polls_pts_for_correct', 'polls_pts_for_incorrect', 'queue_announcement_message', 'seek_message_enabled', 'seek_message_instructions'
        ];
