...
class TestMigrateEnvironmentUp(unittest.TestCase):
    ...
    def test_migrate_system(self):
        ...
        self.assertEqual(
            """Running up migrations for system...  01_test1
  02_test1
DONE
""",
            sys.stdout.getvalue(),
    ...
    def test_migrate_master(self):
        ...
        self.assertEqual(len(missing_migrations), 0)
        self.assertEqual(
            """Running up migrations for master...  01_test2
  02_test2
DONE
""",
            sys.stdout.getvalue(),
    ...
    def test_migrate_course(self):
        ...
        self.assertEqual(len(missing_migrations), 0)
        self.assertEqual(
            """Running up migrations for f18.csci1100...  01_test3
  02_test3
DONE
""",
            sys.stdout.getvalue(),
...
""",
    ...
    def test_fake_migrations(self):
        ...
        self.assertEqual(len(missing_migrations), 0)
        self.assertEqual(
            """Running up migrations for master...  02_test6 (FAKE)
  03_test6 (FAKE)
DONE
""",
            sys.stdout.getvalue(),
    ...
    def test_single_migration(self):
        ...
        self.assertEqual(len(missing_migrations), 0)
        self.assertEqual(
            """Running up migrations for master...  02_test7
DONE
""",
            sys.stdout.getvalue(),
        )
    ...
    def test_single_fake_migration(self):
        ...
        self.assertEqual(len(missing_migrations), 0)
        self.assertEqual(
            """Running up migrations for master...  02_test8 (FAKE)
DONE
""",
            sys.stdout.getvalue(),
        )
