...
class TestSubmission(BaseTestCase):
    ...
    def change_submission_version(self):
        ...
        self.driver.find_element_by_xpath("//div[@class='content']/form/button[@type='submit' and @id='version_change']").click()
    ...
    def test_cancel_submission_version(self):
        ...
        self.driver.find_element_by_xpath("//div[@class='content']/form/button[@type='submit' and @id='do_not_grade']").click()
