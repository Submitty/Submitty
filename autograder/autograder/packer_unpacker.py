...
def prepare_autograding_and_submission_zip(which_machine,which_untrusted,next_directory,next_to_grade):
    ...
    solution_path = os.path.join(SUBMITTY_DATA_DIR,"courses",obj["semester"],obj["course"],"solution",obj["gradeable"])
    ...
    copytree_if_exists(solution_path,os.path.join(tmp_autograding,"solution"))
