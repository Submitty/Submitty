...
class Course_data:
    ...
    def add_sample_queue_data(self) -> None:
        ...
        queues_table = Table("queue_settings", self.metadata, autoload_with=self.engine)
        queue_entries_table = Table("queue", self.metadata, autoload_with=self.engine)
    ...
    def add_sample_polls_data(self) -> None:
        ...
        # add polls to DB
        polls_table = Table("polls", self.metadata, autoload_with=self.engine)
        poll_options_table = Table("poll_options", self.metadata, autoload_with=self.engine)
        poll_responses_table = Table("poll_responses", self.metadata, autoload_with=self.engine)
    ...
    def add_sample_forum_data(self) -> None:
        ...
        forum_threads = Table("threads", self.metadata, autoload_with=self.engine)
        forum_posts = Table("posts", self.metadata, autoload_with=self.engine)
        forum_cat_list = Table("categories_list", self.metadata, autoload_with=self.engine)
        forum_thread_cat = Table("thread_categories", self.metadata, autoload_with=self.engine)
