...
CREATE FUNCTION grab_late_day_gradeables_for_user(user_id text) RETURNS SETOF late_day_cache
	LANGUAGE plpgsql
	AS $$
...
CREATE FUNCTION grab_late_day_updates_for_user(user_id text) RETURNS SETOF late_day_cache
	LANGUAGE plpgsql
	AS $$
#variable_conflict use_variable
DECLARE
...
CREATE FUNCTION late_days_allowed_change() RETURNS trigger
	LANGUAGE plpgsql
	AS $$
BEGIN
	--- Update or Insert
...
CREATE FUNCTION gradeable_version_change() RETURNS trigger AS $$
	BEGIN
		--- Update or Insert
...
CREATE FUNCTION late_day_extension_change() RETURNS trigger AS $$
	#variable_conflict use_variable
	DECLARE
		g_id varchar;
		user_id varchar;
...
CREATE FUNCTION electronic_gradeable_change() RETURNS trigger AS $$
	#variable_conflict use_variable
	DECLARE
		g_id varchar ;
		due_date timestamp;
...
--
-- Name: users gradeable_version_change; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: users late_days_allowed_change; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: users late_day_extension_change; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: users electronic_gradeable_change; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: users gradeable_delete; Type: TRIGGER; Schema: public; Owner: -
--
