...
def up(config, database, semester, course):
    ...
    :type course: str
    """
    database.execute("CREATE TABLE IF NOT EXISTS chatrooms(id SERIAL PRIMARY KEY, host_id integer NOT NULL, title text NOT NULL, description text NOT NULL, is_active BOOLEAN DEFAULT false NOT NULL)")
