 ...
 * @method bool isSelfRegistration()
...
class Config extends AbstractModel {
    ...
    /** @prop
     * @var bool */
    protected $self_registration = false;
    /** @prop
     * @var string|null */
    ...
    public function loadCourseJson($semester, $course, $course_json_path) {
        ...
        $array = [
            ...
            'queue_announcement_message', 'seek_message_enabled', 'seek_message_instructions', 'self_registration'
        ];
