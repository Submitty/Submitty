...
class SubmissionController extends AbstractController {
    ...
    */
    ...
    private function ajaxUploadSubmission() {
        ...
        if ($user_id == $original_user_id)
            $core->addSuccessMessage("Successfully uploaded version {$new_version} for {$gradeable->getName()}");
        else
            $core->addSuccessMessage("Successfully uploaded version {$new_version} for {$gradeable->getName()} for {$who_id}");
