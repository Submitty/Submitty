    ...
    if(json['data']['users'].length === 0){
      ...
      $('#empty-table').text('There are no overridden grades for this homework');
        ...
        json['data']['users'].forEach(function(elem){
            let delete_button = "<button onclick=\"deleteOverriddenGrades('" + elem['user_id'] + "', '" + json['data']['gradeable_id'] + "');\" style='background: none;border:none;all:unset;'><i class='fas fa-trash'></i></button>"
