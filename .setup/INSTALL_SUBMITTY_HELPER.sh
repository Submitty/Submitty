...
# CONFIGURE_SUBMITTY.sh.  That helper script initializes dozens of
...
replace_fillin_variables ${SUBMITTY_INSTALL_DIR}/bin/foo.py
...
chown root:$HWCRON_USER ${SUBMITTY_INSTALL_DIR}/bin/foo.py
chmod 550 ${SUBMITTY_INSTALL_DIR}/bin/grade_item.py
chmod 550 ${SUBMITTY_INSTALL_DIR}/bin/foo.py
