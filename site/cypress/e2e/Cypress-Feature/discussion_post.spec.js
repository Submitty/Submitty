describe('test for discussion post panel', () => {
    it('Enable discussion form and post', () => {
        ...
        cy.get('[data-testid="create-post-head"]').first().should('contain', '(2) Gradeable 1 print clarification');
        cy.get('[data-testid="create-post-head"]').eq(1).should('contain', '(3) Gradeable 1 not running');
