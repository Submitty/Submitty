...
<div class="content">
    <div style="float: right; margin-bottom: 20px;">
        <a href="{$this->core->getConfig()->getTABaseUrl()}account/admin-classlist.php?course={$course}&semester={$semester}&this[]=Students&this[]=Upload%20ClassList" class="btn btn-primary">Upload Classlist</a>
