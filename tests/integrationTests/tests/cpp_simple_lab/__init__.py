...
def cleanup(test):
    subprocess.call(
        ["rm"] + ["-f"] + glob.glob(os.path.join(test.testcase_path, "data", "result*"))
    )
    ...
    subprocess.call(["rm"] + ["-f"] + glob.glob(os.path.join(test.testcase_path, "data", "*out")))
...
def full_credit(test):
    ...
    subprocess.call(
        [
            "cp",
            os.path.join(SAMPLE_SUBMISSIONS, "README.txt"),
    ...
    subprocess.call(
        [
            "cp",
            os.path.join(SAMPLE_SUBMISSIONS, "julian_full_credit.cpp"),
...
def extra_credit(test):
    ...
    subprocess.call(
        [
            "cp",
            os.path.join(SAMPLE_SUBMISSIONS, "julian_extra_credit.cpp"),
            os.path.join(test.testcase_path, "data", "part2"),
        ]
    )
    test.run_compile()
...
def warning(test):
    ...
    subprocess.call(
        [
            "cp",
            os.path.join(SAMPLE_SUBMISSIONS, "julian_warning.cpp"),
            os.path.join(test.testcase_path, "data", "part2"),
        ]
    )
    test.run_compile()
...
def compilation_error(test):
    ...
    subprocess.call(
        [
            "cp",
            os.path.join(SAMPLE_SUBMISSIONS, "julian_compile_error.cpp"),
            os.path.join(test.testcase_path, "data", "part2"),
        ]
    )
    test.run_compile()
...
def buggy(test):
    ...
    subprocess.call(
        [
            "cp",
            os.path.join(SAMPLE_SUBMISSIONS, "julian_buggy.cpp"),
            os.path.join(test.testcase_path, "data", "part2"),
        ]
    )
    test.run_compile()
