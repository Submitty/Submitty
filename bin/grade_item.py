...
def prepare_autograding_and_submission_zip(next_directory,next_to_grade):
    ...
    return (job_id,my_autograding_zip_file,my_submission_zip_file)
...
def grade_from_zip(job_id,my_autograding_zip_file,my_submission_zip_file,which_untrusted):
    os.chdir(SUBMITTY_DATA_DIR)
...
# ==================================================================================
# ==================================================================================
def unpack_grading_results_zip(job_id,my_results_zip_file):
    os.chdir(SUBMITTY_DATA_DIR)
...
def just_grade_item(next_directory,next_to_grade,which_untrusted):
    ...
    try:
        job_id,autograding_zip,submission_zip = prepare_autograding_and_submission_zip(next_directory,next_to_grade)
    except:
    ...
    try:
        results_zip = grade_from_zip(job_id,autograding_zip,submission_zip,which_untrusted)
    except:
    ...
    try:
        unpack_grading_results_zip(job_id,results_zip)
    except:
