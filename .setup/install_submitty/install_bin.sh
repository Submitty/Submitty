...
array=( auto_rainbow_grades.py auto_rainbow_scheduler.py build_config_upload.py send_email.py cleanup_old_email.py cleanup_active_graders.py send_notification.py generate_grade_summaries.py submitty_daemon_jobs grading_clustering)
for i in "${array[@]}"; do
