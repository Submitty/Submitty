                ...
                if (isset($details['array_gcd_gc_id'])) {
                    for ($j = 0; $j < count($details['array_gcd_gc_id']); $j++) {
                        if ($details['array_gcd_gc_id'][$j] === $component_details['gc_id']) {
                          ...
                          /*  if($details["array_gcd_component_comment"][$j] == "Very Good Job112"){
                                echo('gradeable CHECK');
                                echo($details['array_gcd_has_custom'][$j]);
                                echo("\n");
                            }*/
                            $grade_details[$j]['gcd_has_custom'] = false;
                            if($details['array_gcd_has_custom'][$j] == "t"){
                                $grade_details[$j]['gcd_has_custom'] = true;
                            }
