...
def syntax_error(test):
    ...
    test.diff("results_grade.txt","results_grade.txt_syntax_error")
...
def infinite_loop_too_much_output(test):
    ...
    test.diff("results_grade.txt","results_grade.txt_infinite_loop_too_much_output")
...
def infinite_loop_time_cutoff(test):
    ...
    test.diff("results_grade.txt","results_grade.txt_infinite_loop_time_cutoff")
