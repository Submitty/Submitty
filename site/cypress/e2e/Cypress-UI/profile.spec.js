...
describe('Test cases revolving around user profile page', () => {
    ...
    it('should handle the timezone selector correctly', () => {
        ...
        cy.get('#select2-time_zone_drop_down-container').click({ force: true });
        cy.get('input[aria-controls="select2-time_zone_drop_down-results"]').should('be.visible');
        cy.get('input[aria-controls="select2-time_zone_drop_down-results"]').trigger('input', { force: true });
        cy.get('input[aria-controls="select2-time_zone_drop_down-results"]').type('Pacific', { force: true, delay: 100 });
