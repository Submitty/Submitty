...
class OfficeHoursQueueModel extends AbstractModel {
    ...
    */
    ...
    private $niceNames = [
      ...
      'median_help_time' => 'Median Help Time',
      'low_help_time' => '5 PCTL Help Time',
      'high_help_time' => '95 PCTL Help Time',
      'median_wait_time' => 'Median Wait Time',
      'low_wait_time' => '5 PCTL Wait Time',
      'high_wait_time' => '95 PCTL Wait Time',
