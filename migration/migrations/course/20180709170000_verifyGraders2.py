def up(config, conn, semester, course):
    with conn.cursor() as cursor:
        ...
        cursor.execute("CREATE TABLE gradeable_component_data (gc_id integer NOT NULL, gd_id integer NOT NULL, gcd_score numeric NOT NULL, gcd_component_comment character varying NOT NULL, gcd_grader_id character varying(255) NOT NULL, gcd_grader_id2 character varying(255) NULL, gcd_graded_version integer, gcd_grade_time timestamp(6) with time zone NOT NULL)")
