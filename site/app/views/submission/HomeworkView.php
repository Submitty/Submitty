...
class HomeworkView extends AbstractView {
     ...
     * @return string
     */
    public function showGradeable(Gradeable $gradeable, $graded_gradeable, int $display_version, bool $can_inquiry, User $students, $ggs, bool $is_valid, array $count_array, array $files, bool $show_hidden_testcases = false) {
        $return = '';
     ...
     * @return string
     */
    private function renderSubmitBox(Gradeable $gradeable, $graded_gradeable, $version_instance, int $late_days_use, User $students, $ggs): string {
