...
def correct_no_coverage(test):
    ...
    test.run_run()
    test.run_validator()
    test.diff("results_grade.txt","correct_no_coverage_results_grade.txt")
...
def buggy_coverage(test):
    ...
    test.run_run()
    test.run_validator()
    test.diff("results_grade.txt","buggy_coverage_results_grade.txt")
...
def buggy_no_coverage(test):
    ...
    test.run_run()
    test.run_validator()
    test.diff("results_grade.txt","buggy_no_coverage_results_grade.txt")
