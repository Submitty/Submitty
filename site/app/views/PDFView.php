...
class PDFView extends AbstractView {
    ...
    public function showPDFEmbedded(
        ...
        $localjs[] = $this->core->getOutput()->timestampResource(FileUtils::joinPaths('pdfjs-dist', 'pdf_viewer.js'), 'vendor');
        $localjs[] = $this->core->getOutput()->timestampResource(FileUtils::joinPaths('pdfjs-dist', 'pdf.min.mjs'), 'vendor');
        $localjs[] = $this->core->getOutput()->timestampResource(FileUtils::joinPaths('pdfjs-dist', 'pdf.worker.min.mjs'), 'vendor');
