...
submitty_admin_file = os.path.join(
    current_dir, "..", "..", "config", "submitty_admin.json"
)
...
api_token_cmd = [
    os.path.join(current_dir, "..", "..", "sbin", "api_token_generate.php"),
    creds["submitty_admin_username"],
]
response = subprocess.run(
    api_token_cmd, stdout=subprocess.PIPE, stderr=subprocess.PIPE, encoding="utf-8"
)
