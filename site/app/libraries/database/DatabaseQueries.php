  ...
  WHERE gc_is_peer='t' AND g_id=?
    ...
    public function getPostsForThread($current_user, $thread_id, $show_deleted = false, $option = "tree"){
      ...
      if(count($result_rows) > 0){
        $this->course_db->query("INSERT INTO viewed_responses(thread_id,user_id,timestamp) SELECT ?, ?, current_timestamp", array($thread_id, $current_user));
      }
      return $result_rows;
    }
