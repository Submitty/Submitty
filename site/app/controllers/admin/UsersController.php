...
class UsersController extends AbstractController {
    ...
    public function updateUser($action='students') {
        ...
        elseif ($_POST['edit_user'] != "true" && $user !== null) {
            $user->setRegistrationSection($_POST['registered_section'] === "null" ? null : $_POST['registered_section']);
            ...
            $user->setGradingRegistrationSections(!isset($_POST['grading_registration_section']) ? array() : $_POST['grading_registration_section']);
