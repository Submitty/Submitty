...
def main():
    ...
    shutil.move(
        "/var/local/submitty/config/autograding_containers.json", "/tmp/autograding_containers.json"
    )
    ...
    shutil.move(
        "/tmp/autograding_containers.json", "/var/local/submitty/config/autograding_containers.json"
    )
    shutil.chown(
