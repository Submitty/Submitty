...
function build_homework {
    ...
    rsync -ruz --delete  $hw_source/   $hw_build_path || ( echo 'ERROR: configuration source directory does not exist or submitty_daemon cannot read this directory' ; exit 1 )
    ...
    # change permissions so other instructor users in this course & submitty_daemon can re-run the build course script
