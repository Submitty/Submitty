...
class UserProfileView extends AbstractView {
    ...
    public function showUserProfile(
        ...
        $user_lastname_initial = $user->getPreferredLastNameInitial();
        ...
        return $this->output->renderTwigTemplate('UserProfile.twig', [
            ...
            "user_lastname_initial" => $autofill_preferred_name[1][0],
            "user_lastname_initial_option" => $user_lastname_initial,
