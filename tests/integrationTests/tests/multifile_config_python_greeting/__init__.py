...
SAMPLE_ASSIGNMENT_CONFIG = (
    SUBMITTY_INSTALL_DIR + "/more_autograding_examples/multifile_config_python_greeting/config"
)
SAMPLE_SUBMISSIONS = (
    SUBMITTY_INSTALL_DIR + "/more_autograding_examples/multifile_config_python_greeting/submissions"
)
