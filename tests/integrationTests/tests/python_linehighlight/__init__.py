...
SAMPLE_ASSIGNMENT_CONFIG = (
    SUBMITTY_INSTALL_DIR + "/more_autograding_examples/python_linehighlight/config"
)
SAMPLE_SUBMISSIONS = (
    SUBMITTY_INSTALL_DIR + "/more_autograding_examples/python_linehighlight/submissions"
)
