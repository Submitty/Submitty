...
import verify_migration_datestamp
...
class TestVerifyMigrationFreshness(unittest.TestCase):
    ...
    def test_fresh_migration_passes(self, mock_time, mock_get_files):
        now = datetime(2024, 2, 25, 14, 30, 0)
    ...
    def test_custom_max_age_14_days(self, mock_time, mock_get_files):
        # Save original value
        original_max_age = os.environ.get('MAX_MIGRATION_AGE_DAYS')
        
        try:
            # Set to 14 days and reload module
            os.environ['MAX_MIGRATION_AGE_DAYS'] = '14'
            import importlib
            importlib.reload(verify_migration_datestamp)
            ...
            if original_max_age:
                os.environ['MAX_MIGRATION_AGE_DAYS'] = original_max_age
            else:
                os.environ.pop('MAX_MIGRATION_AGE_DAYS', None)
