describe('Rubric Access Test', () => {
    it('test sample file exists student', () => {
        ...
        cy.get('#error-0').should('contain', 'You do not have permission to grade Grading Gradeable');
        cy.get('.alert-error').contains('You do not have permission to grade Grading Gradeable');
        cy.logout();
    });
