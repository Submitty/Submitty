...
class ConfigurationControllerTester extends \PHPUnit\Framework\TestCase {
    ...
    public function testViewConfiguration(): void {
        ...
        $expected = [
            ...
            'queue_whiteboard_message'       => 'whiteboard message'
        ];
