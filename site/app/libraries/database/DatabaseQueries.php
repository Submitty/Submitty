...
ORDER BY user_id ASC"
    ...
    public function updateCourseSectionId($section_id, $course_id) {
        ...
        $semester = $this->core->getConfig()->getTerm();
        $course   = $this->core->getConfig()->getCourse();
        $this->course_db->query("UPDATE sections_registration SET course_section_id = ? 
        WHERE term = ? AND course = ? AND sections_registration_id = ?",[$course_id, $semester, $course, $section_id]);
    }
