...
CREATE TRIGGER saml_mapping_check_trigger BEFORE INSERT OR UPDATE ON public.saml_mapped_users FOR EACH ROW EXECUTE PROCEDURE public.saml_mapping_check();
