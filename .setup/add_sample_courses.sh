...
HSS_SUBMITTY_DIR=/usr/local/hss/GIT_CHECKOUT_Submitty
HSS_INSTALL_DIR=/usr/local/hss
HSS_DATA_DIR=/var/local/hss
sample_assignment_dir=$HSS_INSTALL_DIR/sample_files/sample_assignment_config
...
function one_course {
    ...
    # ---------------------------------------------------------------
    # CREATE THE COURSE
    ${HSS_INSTALL_DIR}/bin/create_course.sh $semester $course instructor $course_group

    
    # ---------------------------------------------------------------
    # WRITE THE ASSIGNMENTS FILE (NORMALLY AUTO GENERATED BY CREATE/EDIT GRADEABLE WEBPAGE)
    assignments_file=/var/local/hss/courses/$semester/$course/ASSIGNMENTS.txt
    ...
    class_json_file=/var/local/hss/courses/$semester/$course/config/class.json
    ...
    ${HSS_DATA_DIR}/courses/$semester/$course/BUILD_${course}.sh


    # ---------------------------------------------------------------
    # CREATE & POPULATE THE DATABASE
    export PGPASSWORD="hsdbu"
    psql -d postgres -h localhost -U hsdbu -c "CREATE DATABASE hss_${course}_${semester};"
    psql -d hss_${course}_${semester} -h localhost -U hsdbu -f ${HSS_SUBMITTY_DIR}/TAGradingServer/data/tables.sql
    psql -d hss_${course}_${semester} -h localhost -U hsdbu -f ${HSS_SUBMITTY_DIR}/TAGradingServer/data/inserts.sql
    psql -d hss_${course}_${semester} -h localhost -U hsdbu -f ${HSS_SUBMITTY_DIR}/.setup/vagrant/db_inserts.sql
    unset PGPASSWORD
}
