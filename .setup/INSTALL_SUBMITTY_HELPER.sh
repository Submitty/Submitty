...
# TODO: REMOVE HARDCODE of /usr/local/submitty/config below.
...
bash "${SUBMITTY_REPOSITORY}/.setup/install_submitty/build_analysis_tools.sh" "config=${SUBMITTY_CONFIG_DIR:?}"
