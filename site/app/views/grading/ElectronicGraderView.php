...
HTML;
            ...
            $posts_view .= <<<HTML
                    <a href="{$this->core->buildCourseUrl(['forum', 'threads', $threadId])}" rel="noopener nofollow" class="btn btn-default btn-sm" style="margin-top:15px; text-decoration: none;" onClick="" data-testid="go-to-thread"> Go to thread</a>
