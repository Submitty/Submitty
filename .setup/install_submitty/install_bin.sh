...
array=( auto_rainbow_grades.py auto_rainbow_scheduler.py build_config_upload.py send_email.py cleanup_old_email.py send_notifications.py generate_grade_summaries.py submitty_daemon_jobs)
for i in "${array[@]}"; do
