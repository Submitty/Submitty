...
class GradeableComponentMark extends AbstractModel {
    ...
    public function saveData($gd_id, $gc_id, $gcd_grader_id, $overwrite=false) {
        if($this->modified){
            if($this->has_mark != $this->original_has_mark) {
            	...
            	if ($this->has_mark) {
                    $this->core->getQueries()->insertGradeableComponentMarkData($gd_id, $gc_id, $this, $gcd_grader_id);
            	} else {
