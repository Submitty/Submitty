...
HTML;
    ...
    <input type="hidden" name="csrf_token" value="{$this->core->getCsrfToken()}" />
        ...
        <div class="option" style="width:25%; display:inline-block;">Extension Days:<br><input class="option-input" type="text" name="late_days" id="late_days" style="float:left"></div>
        ...
        <div>Do not use column headers. CSV must be of the following form: student_id, gradeable_id, extension_days</div>
