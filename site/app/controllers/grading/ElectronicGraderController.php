...
class ElectronicGraderController extends AbstractController {
    ...
    public function showGrading(
        ...
        if ($who_id === '') {
            ...
            if ($this->core->getUser()->accessFullGrading() && !$force_grading_sections) {
            ...
            if ($to === 'prev' && !$force_grading_sections && $this->core->getUser()->accessFullGrading()) {
            ...
            elseif ($to === 'next' && !$force_grading_sections && $this->core->getUser()->accessFullGrading()) {
