...
def no_fork(test):
    ...
    test.run_run()
    test.run_validator()
    test.diff("results_grade.txt","no_fork_results_grade.txt","-b")
...
def serial_fork(test):
    ...
    test.run_run()
    test.run_validator()
    test.diff("results_grade.txt","serial_fork_results_grade.txt","-b")
...
def parallel_fork(test):
    ...
    test.run_run()
    test.run_validator()
    test.diff("results_grade.txt","parallel_fork_results_grade.txt","-b")
...
def tree_fork(test):
    ...
    test.run_run()
    test.run_validator()
    test.diff("results_grade.txt","tree_fork_results_grade.txt","-b")
...
#    test.run_run()
#    test.run_validator()
#    test.diff("results_grade.txt","fork_bomb_print_results_grade.txt","-b")
