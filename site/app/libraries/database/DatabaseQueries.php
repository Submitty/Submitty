...
VALUES (?,?,?,?,?,?)",
    ...
    public function updateUser(User $user, $semester = null, $course = null) {
        $params = [$user->getNumericId(), $user->getLegalGivenName(), $user->getPreferredGivenName(),
                       $user->getLegalFamilyName(), $user->getPreferredFamilyName(), $user->getEmail(), $user->getSecondaryEmail(), $user->getPronouns(),
...
SET
  ...
  user_email=?, user_email_secondary=?, user_pronouns=?, user_email_secondary_notify=?,
