...
describe('Test cases for PDFs access', () => {
    ...
    it('users should have access to basic pdfs', () => {
        pdf_access('instructor', '3', '8' ,'grading_homework_pdf', 'words_1463.pdf');
        cy.logout();
        pdf_access('ta', '3', '8', 'grading_homework_pdf', 'words_1463.pdf');
        cy.logout();
        pdf_access('grader', '4', '8', 'grading_homework_pdf', 'words_881.pdf');
    });

    it('users should have access to team pdfs', () => {
        pdf_access('instructor', '3', '9', 'grading_homework_team_pdf', 'words_881.pdf');
        cy.logout();
        pdf_access('ta', '3', '9', 'grading_homework_team_pdf', 'words_881.pdf');

        // cy.logout();
        // grader have no grades to grade
        // pdf_access('grader','1', '6', 'grading_homework_team_pdf', 'words_881.pdf')
    });

    it('users should have access to peer pdfs', () => {
        pdf_access('instructor', '3', '8', 'grading_pdf_peer_homework', 'words_1463.pdf');
        cy.logout();
        pdf_access('ta', '3', '8', 'grading_pdf_peer_homework', 'words_1463.pdf');
        cy.logout();

        // pdf_access('grader','2', '8', 'grading_pdf_peer_homework', 'words_249.pdf');
        pdf_access('student','9', '5', 'grading_pdf_peer_homework', 'words_881.pdf');
    });

    it('users should have access to peer team pdfs', () => {
        pdf_access('instructor', '2', '9', 'grading_pdf_peer_team_homework', 'words_1463.pdf');
        cy.logout();
        pdf_access('ta', '2', '9', 'grading_pdf_peer_team_homework', 'words_1463.pdf');

        // pdf_access('grader', '2', '6', 'grading_pdf_peer_team_homework', 'words_1463.pdf');
        // pdf_access('bauchg', '1', '5', 'grading_pdf_peer_team_homework', 'words_881.pdf');
    });
