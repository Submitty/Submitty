...
alias install_lichen='sudo bash /usr/local/submitty/GIT_CHECKOUT/Lichen/install_lichen.sh'
alias lichen_install='sudo bash /usr/local/submitty/GIT_CHECKOUT/Lichen/install_lichen.sh'
