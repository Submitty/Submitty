<?php 
	...
	<div id="container-rubric">
		<div class="modal-header">
			<h3 id="myModalLabel">Homework {$_GET['hw']} Summary</h3>
		</div>
...
HTML;
	...
	$db->query("SELECT r.rubric_id,sum(question_total) as score FROM rubrics AS r,
	questions AS q WHERE r.rubric_number=? AND q.rubric_id=r.rubric_id GROUP BY r.rubric_id", $params);
