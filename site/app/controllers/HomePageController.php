...
class HomePageController extends AbstractController {
    ...
    public function getCourses($user_id = null, $as_instructor = false) {
        ...
        $self_registeration_courses = $this->core->getQueries()->getSelfRegisterCourses($user_id);
        if ($as_instructor) {
        ...
        return MultiResponse::JsonOnlyResponse(
            JsonResponse::getSuccessResponse([
                ...
                "self_registeration_courses" => array_map($callback, $self_registeration_courses)
            ])
        );
    }
    ...
    public function showHomepage() {
        ...
        return new MultiResponse(
            ...
            new WebResponse(
                ...
                $courses["data"]["self_registeration_courses"]
            )
        );
    }
