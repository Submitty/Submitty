...
WHERE gcm_id=?", $params);
    ...
    /**
     * Generates a new team id from a user's name
     * @param string $user_id
     * @return string
     */
    public function generateTeamId(string $user_id) {
        ...
        return "{$team_id_prefix}_{$user_id}";
    }

    /**
     * Creates a new team from in id generated by generateTeamId
     * @param string $g_id
     * @param string $team_id
     * @param string $user_id The id of the team starter/leader
    ...
    public function createTeam($g_id, $user_id, $registration_section, $rotating_section) {
        $team_id = $this->generateTeamId($user_id);
        $this->createTeamById($g_id, $team_id, $user_id, $registration_section, $rotating_section);
        return $team_id;
    }
