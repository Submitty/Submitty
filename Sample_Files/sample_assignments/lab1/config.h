...
TestCase::MakeTestCase(
	 ...
	 new TestCaseComparison(&myersDiffbyLinebyChar,				// compare function [V]			   ),
			    "cout.txt",					// output file name [V]
			    "Standard OUTPUT (STDOUT)",					// output file description
<<<<<<< HEAD:Sample_Files/sampleConfig/csci1200_lab1_getting_started/config.h
...
=======
	 ...
	 new TestCaseComparison(&myersDiffbyLinebyChar,				// compare function [V]			   ),
>>>>>>> 050c612bbd2a4f5588b0157dba112d2cbed939de:Sample_Files/sample_assignments/lab1/config.h
