...
def allCorrect(test):
    ...
    test.diff("results_grade.txt","results_grade.txt_allCorrect")
...
def columnSpacingOff(test):
    ...
    test.run_run()
    test.run_validator()
    test.diff("results_grade.txt","results_grade.txt_columnSpacingOff")
...
def extraLinesAtEnd(test):
    ...
    test.run_run()
    test.run_validator()
    test.diff("results_grade.txt","results_grade.txt_extraLinesAtEnd")
...
def extraSpacesAtEnd(test):
    ...
    test.run_run()
    test.run_validator()
    test.diff("results_grade.txt","results_grade.txt_extraSpacesAtEnd")
...
def frontSpacingOff(test):
    ...
    test.run_run()
    test.run_validator()
    test.diff("results_grade.txt","results_grade.txt_frontSpacingOff")
...
def lineOrderOff(test):
    ...
    test.run_run()
    test.run_validator()
    test.diff("results_grade.txt","results_grade.txt_lineOrderOff")
...
def spacingOff(test):
    ...
    test.run_run()
    test.run_validator()
    test.diff("results_grade.txt","results_grade.txt_spacingOff")
...
def spellingOff(test):
    ...
    test.run_run()
    test.run_validator()
    test.diff("results_grade.txt","results_grade.txt_spellingOff")
