...
class Course_create:
    ...
    def create(self):
        ...
        self.gradeable_component_data = Table("gradeable_component_data", self.metadata, autoload=True)
        self.gradeable_component_mark_data = Table('gradeable_component_mark_data', self.metadata, autoload=True)
        self.gradeable_data_overall_comment = Table('gradeable_data_overall_comment', self.metadata, autoload=True)
        self.electronic_gradeable_data = Table("electronic_gradeable_data", self.metadata, autoload=True)
