...
If the instructor chooses to supply a manual_customization.json instead of using
...
# Constants
PROVIDED_JSON_NAME = 'manual_customization.json'
...
with open(log_file_path, 'w') as f:
    ...
    # Verify that customization.json or manual_customization.json exist
    ...
    # Determine if the instructor has provided a manual_customization.json
