...
if($user_is_administrator)
{
    ...
    <div id="container" style="width:100%; margin-top:40px;">
        <div class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="Grading Done" aria-hidden="false" style="display: block; margin-top:5%; z-index:100;">
            <form onsubmit="submitAJAX('ajax/admin-hw-report.php?course=<?php echo $_GET['course']; ?>&hw=');return false;">
                ...
                <div class="modal-body" style="padding-top:20px; padding-bottom:20px;">
                    ...
                    <div class="loading-gif" style="display:none;"><span style="float: left;margin-left: -100px;margin-top: 10px;">Generating...</span><img src="../toolbox/include/custom/img/loading.gif"></div>
                </div>

                <div class="modal-footer">
                    <div style="width:50%; float:left; text-align:left;">
                        <label style="display: inline;"><input type="checkbox" style="margin-top:0px;" name="regrade" id="regrade" /> Only Regrades (ignore new grades)</label><br />
                        <label style="display: inline;"><input type="checkbox" style="margin-top:0px;" name="all" id="all" /> Grade All Homeworks</label><br />
                        <label style="display: inline;"><input type="checkbox" style="margin-top:0px;" name="email" id="email" /> Email Homework Results</label>
                    </div>
