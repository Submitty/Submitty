...
namespace dispatch {
    ...
    bool tolerance_diff (const std::string &expected_file_contents, std::string &student_file_contents, const float &tolerance, const bool &ignoreWhitespace, const bool &extraStudentOutputOk);
}
