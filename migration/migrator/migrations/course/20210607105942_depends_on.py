...
def up(config, database, semester, course):
    ...
    database.execute("ALTER TABLE electronic_gradeable ADD CONSTRAINT IF NOT EXISTS fk_depends_on FOREIGN KEY(eg_depends_on) REFERENCES electronic_gradeable(g_id);")
