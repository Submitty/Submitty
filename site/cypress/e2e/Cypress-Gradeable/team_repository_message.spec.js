describe('Test repository error message on manage team page', () => {
    ...
    it('Should show repository message for VCS team gradeable', () => {
        // Login as a student
        cy.login('student');
        cy.visit(['sample', 'gradeable', 'open_vcs_homework', 'team']);
        cy.get('body').then(($body) => {
            const hasRepoInstructions = $body.text().includes('To access your Team Repository');
