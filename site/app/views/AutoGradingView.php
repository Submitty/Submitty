...
HTML;
        ...
        <div class = "sub">
            ...
            <a name="show_late_table" style="float:right" class="btn btn-primary" href="{$this->core->buildUrl(array('component' => 'student', 'page' => 'view_late_table'))}">Show my late days information</a>
            <div class = "box">
                <div class="box-title">
