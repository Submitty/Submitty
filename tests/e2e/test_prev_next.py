...
class TestGradingNextPrev(BaseTestCase):
    ...
    def test_instructor(self):
        ...
        self.driver.find_element_by_xpath(
            '//a[contains(@href,"/sample/gradeable/grading_homework/grading/status")]'
        ).click()
        self.driver.find_element_by_link_text("Grading Index").click()
        self.driver.find_element_by_xpath(
            '//a[contains(@href,"/sample/gradeable/grading_homework/grading/grade?who_id=student&sort=id&direction=ASC")]'
        ).click()
    ...
    def test_instructor_team(self):
        ...
        self.click_class("sample")
        self.driver.find_element_by_xpath(
            '//a[contains(@href,"/sample/gradeable/grading_team_homework/grading/status")]'
        ).click()
        self.driver.find_element_by_link_text("Grading Index").click()
        proper_team_names_column = (
            self.driver.find_element_by_xpath(
                "//tbody[@class='details-content panel-content-active']/tr[5]/td[7]"
    ...
    def test_ta_team(self):
        ...
        proper_team_names_column = (
            self.driver.find_element_by_xpath(
                "//tbody[@class='details-content panel-content-active']/tr[5]/td[5]"
            ).find_elements_by_tag_name("a")[0]
        ).click()
        self.driver.find_element_by_id("prev-student").click()
        self.assertIn("John Smith", self.driver.find_element_by_id("student_info").text)
    ...
    def test_instructor_navigate_away(self):
        ...
        self.driver.find_element_by_link_text("Grading Index").click()
        self.driver.find_element_by_xpath(
            '//a[contains(@href,"/sample/gradeable/grading_homework/grading/grade?who_id=aphacker&sort=id&direction=ASC")]'
        ).click()
        self.driver.find_element_by_id("prev-student").click()
        self.assertIn(
            "No prev assigned ungraded student found!",
            self.driver.find_element_by_id("messages").text,
        )
