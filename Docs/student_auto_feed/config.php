...
define('COLUMN_COURSE_PREFIX', 7);  //Course prefix
define('COLUMN_COURSE_NUMBER', 8);  //Course number
define('COLUMN_REGISTRATION',  13); //Student enrollment status
define('COLUMN_SECTION',       10); //Section student is enrolled
define('COLUMN_CSID',          19); //Student's computer systems ID
define('COLUMN_FNAME',         3);  //Student's First Name
define('COLUMN_LNAME',         2);  //Student's Last Name
define('COLUMN_PNAME',         4);  //Student's Preferred Name
define('COLUMN_EMAIL',         6);  //Student's Campus Email
