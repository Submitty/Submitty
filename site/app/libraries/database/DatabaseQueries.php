...
eg_subdirectory=?, eg_team_assignment=?, eg_inherit_teams_from=?, eg_max_team_size=?, eg_team_lock_date=?, eg_use_ta_grading=?, eg_student_view=?, eg_student_submit=?,
