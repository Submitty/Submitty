...
class Core {
    ...
    public function getPollsDropdownStates(): array {
        $ret = [true, false, false]; // corresponding to default dropdown states for (today, old, future)
        $cookie_keys = ['today_polls_dropdown', 'old_polls_dropdown', 'future_polls_dropdown'];
