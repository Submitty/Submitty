...
#
# The default settings are ok, but you can edit /etc/ntpsec/ntp.conf and
...
apt-get install -qqy postgresql-16
...
p7zip-full patchutils libpq-dev unzip valgrind zip libboost-all-dev gcc-14 g++-14 \
