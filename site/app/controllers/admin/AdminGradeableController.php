...
class AdminGradeableController extends AbstractController {
    ...
    private function editPage(Gradeable $gradeable, $semester, $course, $nav_tab = 0) {
        ...
        $check_refresh_url = $this->core->buildCourseUrl(['gradeable', $gradeable->getId(), 'check_refresh']);
    ...
    public function rebuildGradeableRequest($gradeable_id) {
        ...
        $this->core->redirect($this->core->buildCourseUrl(['gradeable', $gradeable->getId(), 'update']) . '?' . http_build_query(['nav_tab' => '1']));
    }
