...
SAMPLE_ASSIGNMENT_CONFIG = (
    SUBMITTY_INSTALL_DIR + "/more_autograding_examples/cpp_hidden_tests/config"
)
SAMPLE_SUBMISSIONS = (
    SUBMITTY_INSTALL_DIR + "/more_autograding_examples/cpp_hidden_tests/submissions"
)
...
def correct(test):
    ...
    subprocess.call(
        [
            "cp",
            os.path.join(SAMPLE_SUBMISSIONS, "frame.cpp"),
...
def noerrorchecking(test):
    ...
    subprocess.call(
        [
            "cp",
            os.path.join(SAMPLE_SUBMISSIONS, "frame_noerrorchecking.cpp"),
            os.path.join(test.testcase_path, "data"),
        ]
    )
    test.run_compile()
...
def hardcoded(test):
    ...
    subprocess.call(
        [
            "cp",
            os.path.join(SAMPLE_SUBMISSIONS, "frame_hardcoded.cpp"),
            os.path.join(test.testcase_path, "data"),
        ]
    )
    test.run_compile()
...
def buggy(test):
    ...
    subprocess.call(
        [
            "cp",
            os.path.join(SAMPLE_SUBMISSIONS, "frame_buggy.cpp"),
            os.path.join(test.testcase_path, "data"),
        ]
    )
    test.run_compile()
