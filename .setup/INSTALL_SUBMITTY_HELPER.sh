...
replace_fillin_variables ${SUBMITTY_INSTALL_DIR}/bin/grade_items_loop.py
...
chown root:$HWCRON_USER ${SUBMITTY_INSTALL_DIR}/bin/grade_items_loop.py
chown root:$HWCRON_USER ${SUBMITTY_INSTALL_DIR}/bin/submitty_utils.py
chmod 550 ${SUBMITTY_INSTALL_DIR}/bin/grade_item.py
chmod 550 ${SUBMITTY_INSTALL_DIR}/bin/grade_items_loop.py
