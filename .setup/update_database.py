...
for term in os.scandir(os.path.join(settings['submitty_data_dir'],"courses")):
    for course in os.scandir(os.path.join(settings['submitty_data_dir'], "courses", term.name)):
        ...
        os.system("""PGPASSWORD='{}' psql --host={} --username={} --dbname={} -c 'CREATE TABLE "viewed_responses" ("regrade_id" int NOT NULL, "user_id" character varying NOT NULL, "timestamp" timestamp with time zone NOT NULL)'""".format(*variables))
        os.system("""PGPASSWORD='{}' psql --host={} --username={} --dbname={} -c 'CREATE TABLE "student_favorites" ("id" serial NOT NULL, "user_id" character varying NOT NULL, "regrade_id" int, CONSTRAINT student_favorites_pk PRIMARY KEY ("id"))'""".format(*variables))
        ...
        os.system("""PGPASSWORD='{}' psql --host={} --username={} --dbname={} -c 'CREATE TABLE "thread_categories" ("regrade_id" int NOT NULL, "category_id" int NOT NULL)'""".format(*variables))
        ...
        os.system("""PGPASSWORD='{}' psql --host={} --username={} --dbname={} -c 'CREATE TABLE "posts" ("id" serial NOT NULL,"regrade_id" int NOT NULL,"parent_id" int DEFAULT '-1',"author_user_id" character varying NOT NULL,"content" TEXT NOT NULL,"timestamp" timestamp with time zone NOT NULL,"anonymous" BOOLEAN NOT NULL,"deleted" BOOLEAN NOT NULL DEFAULT 'false',"endorsed_by" varchar,"resolved" BOOLEAN NOT NULL,"type" int NOT NULL, "has_attachment" BOOLEAN NOT NULL, CONSTRAINT posts_pk PRIMARY KEY ("id"))'""".format(*variables))

        os.system("""PGPASSWORD='{}' psql --host={} --username={} --dbname={} -c 'ALTER TABLE "posts" ADD CONSTRAINT "posts_fk0" FOREIGN KEY ("regrade_id") REFERENCES "threads"("id")'""".format(*variables))
        ...
        os.system("""PGPASSWORD='{}' psql --host={} --username={} --dbname={} -c 'ALTER TABLE "thread_categories" ADD CONSTRAINT "thread_categories_fk0" FOREIGN KEY ("regrade_id") REFERENCES "threads"("id")'""".format(*variables))
        ...
        os.system("""PGPASSWORD='{}' psql --host={} --username={} --dbname={} -c 'ALTER TABLE "student_favorites" ADD CONSTRAINT "student_favorites_fk1" FOREIGN KEY ("regrade_id") REFERENCES "threads"("id")'""".format(*variables))
        os.system("""PGPASSWORD='{}' psql --host={} --username={} --dbname={} -c 'ALTER TABLE "viewed_responses" ADD CONSTRAINT "viewed_responses_fk0" FOREIGN KEY ("regrade_id") REFERENCES "threads"("id")'""".format(*variables))
        ...
        os.system("""PGPASSWORD='{}' psql --host={} --username={} --dbname={} -c 'ALTER TABLE ONLY thread_categories ADD CONSTRAINT thread_and_category_unique UNIQUE (regrade_id, category_id)'""".format(*variables))
        os.system("""PGPASSWORD='{}' psql --host={} --username={} --dbname={} -c 'ALTER TABLE ONLY student_favorites ADD CONSTRAINT user_and_thread_unique UNIQUE (user_id, regrade_id)'""".format(*variables))
        ...
        os.system("""PGPASSWORD='{}' psql --host={} --username={} --dbname={} -c \"INSERT INTO thread_categories(regrade_id, category_id) SELECT id, 1 as category_id FROM threads\"""".format(*variables))
        ...
        os.system("""PGPASSWORD='{}' psql --host={} --username={} --dbname={} -c 'CREATE TABLE "regrade_requests" ("id" serial NOT NULL, "gradeable_id" VARCHAR(255) NOT NULL,"timestamp" TIMESTAMP NOT NULL, "student_id" VARCHAR(255) NOT NULL, "status" INTEGER DEFAULT 0 NOT NULL)'""".format(settings['database_password'], settings['database_host'], settings['database_user'], db))
        os.system("""PGPASSWORD='{}' psql --host={} --username={} --dbname={} -c 'CREATE TABLE "regrade_discussion" ("id" serial NOT NULL, "user_id" varchar(255) NOT NULL,"timestamp" TIMESTAMP NOT NULL,"content" TEXT,"regrade_id" VARCHAR(255) NOT NULL,"deleted" BOOLEAN default false NOT NULL,regrade_id INTEGER DEFAULT 0 NOT NULL)'""".format(settings['database_password'], settings['database_host'], settings['database_user'], db))

        os.system("""PGPASSWORD='{}' psql --host={} --username={} --dbname={} -c 'ALTER TABLE "regrade_discussion" ADD CONSTRAINT "regrade_discussion_regrade_requests_id_fk" FOREIGN KEY ("regrade_id") REFERENCES "regrade_requests"("id")'""".format(settings['database_password'], settings['database_host'], settings['database_user'], db))
        ...
        os.system("PGPASSWORD='{}' psql --host={} --username={} --dbname={} -c 'ALTER TABLE ONLY threads ADD COLUMN merged_regrade_id int DEFAULT '-1''".format(*variables))
