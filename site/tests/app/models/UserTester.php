    ...
    public function testToObject() {
        ...
        $expected = [
            ...
            'notification_settings' => [
                ...
                'all_announcements_email' => true,
                'all_reply_thread' => true,
                'all_reply_thread_email' => true,
                'all_my_post_altered' => true,
                'all_my_post_altered_email' => true,
                'grade_inquiry_submitted' => true,
                'grade_inquiry_submitted_email' => true,
                'grade_inquiry_post' => true,
                'grade_inquiry_post_email' => true,
                'grade_inquiry_resolved' => true,
                'grade_inquiry_resolved_email' => true,
                'grade_inquiry_resolved_reopened' => true,
                'grade_inquiry_resolved_reopened_email' => true,
