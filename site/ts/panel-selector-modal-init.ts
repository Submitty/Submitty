$(() => {
    ...
    const equalHeight2PanelCanvas: HTMLCanvasElement | null = document.querySelector('#layout-option-2 #equal-height');
    const equalHeight2PanelCanvasCTX = equalHeight2PanelCanvas?.getContext('2d');
    if (equalHeight2PanelCanvasCTX) {
    ...
    const tallLeft2PanelCanvas: HTMLCanvasElement | null = document.querySelector('#layout-option-2 #tall-left');
    const tallLeft2PanelCanvasCTX = tallLeft2PanelCanvas?.getContext('2d');
    if (tallLeft2PanelCanvasCTX) {
    ...
    const equalTwoInLeftPanelCanvas: HTMLCanvasElement | null = document.querySelector('#layout-option-3 #equal-two-in-left');
    const equalTwoInLeftPanelCanvasCTX = equalTwoInLeftPanelCanvas?.getContext('2d');
    if (equalTwoInLeftPanelCanvasCTX) {
    ...
    const equalTwoInRightPanelCanvas: HTMLCanvasElement | null = document.querySelector('#layout-option-3 #equal-two-in-right');
    const equalTwoInRightPanelCanvasCTX = equalTwoInRightPanelCanvas?.getContext('2d');
    if (equalTwoInRightPanelCanvasCTX) {
    ...
    const tallLeftTwoInLeftPanelCanvas: HTMLCanvasElement | null = document.querySelector('#layout-option-3 #tall-left-two-in-left');
    const tallLeftTwoInLeftPanelCanvasCTX = tallLeftTwoInLeftPanelCanvas?.getContext('2d');
    if (tallLeftTwoInLeftPanelCanvasCTX) {
    ...
    const tallLeftTwoInRightPanelCanvas: HTMLCanvasElement | null = document.querySelector('#layout-option-3 #tall-left-two-in-right');
    const tallLeftTwoInRightPanelCanvasCTX = tallLeftTwoInRightPanelCanvas?.getContext('2d');
    if (tallLeftTwoInRightPanelCanvasCTX) {
    ...
    const equalFourPanelCanvas: HTMLCanvasElement | null = document.querySelector('#layout-option-4 #equal-four-panel');
    const equalFourPanelCanvasCTX = equalFourPanelCanvas?.getContext('2d');
    if (equalFourPanelCanvasCTX) {
    ...
    const tallLeftFourPanelCanvas: HTMLCanvasElement | null = document.querySelector('#layout-option-4 #tall-left-four-panel');
    const tallLeftFourPanelCanvasCTX = tallLeftFourPanelCanvas?.getContext('2d');
    if (tallLeftFourPanelCanvasCTX) {
