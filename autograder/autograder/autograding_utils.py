...
def archive_autograding_results(
    ...
    if "generate_output" not in queue_obj:
        ...
        item_name = os.path.join(queue_obj["term"], queue_obj["course"], "submissions", partial_path)
    elif queue_obj["generate_output"]:
        item_name = os.path.join(queue_obj["term"], queue_obj["course"], "generated_output", queue_obj["gradeable"])
