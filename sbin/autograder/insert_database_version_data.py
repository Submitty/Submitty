...
only be readable/executable by the submitty_daemon user as it does contain the database information and we
do notwant some crafty student to try and get access to it. Thus the file should be owned by
submitty_daemon and the permissions set to 500.
