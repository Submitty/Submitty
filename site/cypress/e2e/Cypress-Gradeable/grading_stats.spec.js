...
describe('Test cases for grading stats', () => {
    ['instructor', 'ta', 'grader'].forEach((user) => {
        ...
        it(`${user} view should be accurate for team gradeables.`, () => {
            ...
            cy.get('@left-chunk-stats').should('contain', 'Section 1: 1 / 3 (33.3%)');
            ...
            cy.get('@left-chunk-stats').should('contain', 'Section 1: 2 / 4 (50.0%)');
        ...
        it(`${user} view should be accurate for non team gradeables.`, () => {
            ...
            cy.get('@left-chunk-stats').should('contain', 'Section 3: 3 / 7 (42.9%)');
            ...
            cy.get('@left-chunk-stats').should('contain', 'Section 3: 4 / 9 (44.4%)');
            ...
            cy.get('@left-chunk-stats').should('contain', 'Section NULL: 12 / 23 (52.2%)');
            ...
            cy.get('@left-chunk-stats').should('contain', 'Section NULL: 12 / 26 (46.2%)');
        ...
        it(`${user} view should be accurate for released grades.`, () => {
            ...
            cy.get('@left-chunk-stats').should('contain', 'Section 10: 3 / 3 (100.0%)');
            ...
            cy.get('@left-chunk-stats').should('contain', 'Section 10: 4 / 4 (100.0%)');
            ...
            cy.get('@left-chunk-stats').should('contain', 'Section NULL: 22 / 22 (100.0%)');
        ...
        //NEED A GRADEABLE IN SAMPLE COURSE WITH SUBMISSIONS FOR BULK UPLOAD THAT ARE GRADED
    });
});
