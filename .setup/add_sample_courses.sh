...
function one_course {
    ...
    then
        ...
        psql -d submitty_${semester}_${course} -h localhost -U hsdbu -f ${SUBMITTY_REPOSITORY}/site/data/inserts.sql
        psql -d submitty_${semester}_${course} -h localhost -U hsdbu -f ${SUBMITTY_REPOSITORY}/site/data/db_inserts.sql
    else
