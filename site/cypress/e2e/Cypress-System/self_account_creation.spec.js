...
describe('Self account creation tests', () => {
    it('Test client-side validation preserves form fields', () => {
        ...
        cy.get('[data-testid="email"]').should('have.value', 'test@gmail.com');
        cy.get('[data-testid="user-id"]').should('have.value', 'testuser');
        ...
        cy.get('[data-testid="password"]').should('not.have.value', '');
        cy.get('[data-testid="confirm-password"]').should('not.have.value', '');
    });
