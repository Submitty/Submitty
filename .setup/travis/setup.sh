...
su -c '/usr/local/submitty/sbin/submitty_autograding_shipper.py' submitty_daemon &
sleep 1
su -c '/usr/local/submitty/sbin/submitty_autograding_worker.py' submitty_daemon &
sleep 1
