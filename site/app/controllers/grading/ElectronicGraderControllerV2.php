...
class ElectronicGraderControllerV2 extends AbstractController {
    /**
    ...
    public function showStatus($gradeable_id) {
        ...
        $this->core->getOutput()->renderOutput(
            array('grading', 'ElectronicGraderV2'),
            'statusPage',
            $gradeable,
            $sections,
            $component_averages,
    ...
    public function showDetails($gradeable_id, $view = null, $sort = "id", $direction = "ASC") {
        ...
        $this->core->getOutput()->renderOutput(array('grading', 'ElectronicGraderV2'), 'detailsPage', $gradeable, $graded_gradeables, $teamless_users, $graders, $empty_teams, $show_all_sections_button, $show_import_teams_button, $show_export_teams_button, $show_edit_teams, $past_grade_start_date, $view_all, $sort, $direction);
        ...
        if ($show_edit_teams) {
            ...
            $students = $this->core->getQueries()->getAllUsers();
            $this->core->getOutput()->renderOutput(array('grading', 'ElectronicGraderV2'), 'adminTeamForm', $gradeable, $all_reg_sections, $all_rot_sections, $students);
            $this->core->getOutput()->renderOutput(array('grading', 'ElectronicGraderV2'), 'importTeamForm', $gradeable);

            $this->core->getOutput()->renderOutput(array('grading','ElectronicGraderV2'), 'randomizeButtonWarning', $gradeable);
        }
    }
     ...
     *
     * @Route("/{_semester}/{_course}/gradeable/{gradeable_id}/grading/grade/beta")
     */
    public function showGrading($gradeable_id, $who_id = '', $from = "", $to = null, $gradeable_version = null, $sort = "id", $direction = "ASC", $to_ungraded = null, $component_id = "-1") {
        ...
        $this->core->getOutput()->renderOutput(array('grading', 'ElectronicGraderV2'), 'hwGradingPage', $gradeable, $graded_gradeable, $display_version, $progress, $show_hidden, $can_inquiry, $can_verify, $show_verify_all, $show_silent_edit, $late_status, $rollbackSubmission, $sort, $direction, $who_id);
        $this->core->getOutput()->renderOutput(array('grading', 'ElectronicGraderV2'), 'popupStudents');
        $this->core->getOutput()->renderOutput(array('grading', 'ElectronicGraderV2'), 'popupMarkConflicts');
        $this->core->getOutput()->renderOutput(array('grading', 'ElectronicGraderV2'), 'popupSettings');
    }
